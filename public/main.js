...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // ========================
  //  1️⃣ Анимация сайта (ScrollReveal)
  // ========================
  ...
  // ========================
  //  2️⃣ Скролл к форме "Оставить заявку"
  // ========================
  ...
  // ========================
  //  5️⃣ Яндекс карта (ленивая загрузка)
  // ========================
  ...
  if (form) {
    ...
    if (agreementCheckbox && agreementDialog) {
      ...
      if (acceptBtn) acceptBtn.addEventListener("click", () => { agreementCheckbox.checked = true; agreementDialog.close(); });
      if (declineBtn) declineBtn.addEventListener("click", () => { agreementCheckbox.checked = false; agreementDialog.close(); });
    }
